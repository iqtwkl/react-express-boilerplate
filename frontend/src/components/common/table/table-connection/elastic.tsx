...
export function ElasticSettings() {
    const allConnections = [
        { "id": 1, "name": "Genta", "ip": "192.168.1.1", "author": "Viewer" },
        { "id": 2, "name": "Evander", "ip": "192.168.1.1", "author": "Editor" },
        { "id": 3, "name": "Iqbal", "ip": "192.168.1.1", "author": "Admin" },
        { "id": 4, "name": "Suci", "ip": "192.168.1.1", "author": "Viewer" },
        { "id": 5, "name": "Rivani", "ip": "192.168.1.1", "author": "Contributor" },
        { "id": 6, "name": "Putri", "ip": "192.168.1.2", "author": "Viewer" },
        { "id": 7, "name": "Rina", "ip": "192.168.1.2", "author": "Editor" },
        { "id": 8, "name": "Agus", "ip": "192.168.1.3", "author": "Admin" },
        { "id": 9, "name": "Budi", "ip": "192.168.1.3", "author": "Viewer" },
        { "id": 10, "name": "Siti", "ip": "192.168.1.3", "author": "Contributor" }
    ];
    ...
    return (
        <>
            ...
            <div className="bg-[#D0DEDF] mx-3 mt-2 h-96 rounded-3xl">
                <br />
                <div className="mx-5 mb-3 min-w-screen rounded-lg shadow-md overflow-hidden">
