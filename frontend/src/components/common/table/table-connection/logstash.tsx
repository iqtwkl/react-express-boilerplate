...
export function LogstashSettings() {
    const allConnections = [
        { "id": 1, "name": "Dadang", "ip": "192.168.1.1", "author": "Viewer" },
        { "id": 2, "name": "Wawan", "ip": "192.168.1.1", "author": "Editor" },
        { "id": 3, "name": "Asep", "ip": "192.168.1.1", "author": "Admin" },
        { "id": 4, "name": "Bima", "ip": "192.168.1.1", "author": "Viewer" },
        { "id": 5, "name": "Uut", "ip": "192.168.1.1", "author": "Contributor" },
        { "id": 6, "name": "Doel", "ip": "192.168.1.2", "author": "Viewer" },
        { "id": 7, "name": "Titi", "ip": "192.168.1.2", "author": "Editor" },
        { "id": 8, "name": "Elvi", "ip": "192.168.1.3", "author": "Admin" },
        { "id": 9, "name": "Vika", "ip": "192.168.1.3", "author": "Viewer" },
        { "id": 10, "name": "Lesti", "ip": "192.168.1.3", "author": "Contributor" }
    ];
