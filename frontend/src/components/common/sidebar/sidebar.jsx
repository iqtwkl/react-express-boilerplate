        ...
        <aside className="fixed top-20 left-0 mt-10 mb-4 z-20 flex-col flex-shrink-0 hidden w-64 h-full font-normal duration-75 lg:flex transition-width">
            ...
            >
                <div className="pb-3 pt-5">
                    <p className="self-center whitespace-nowrap text-sm font-normal text-gray-50 dark:text-white pb-4">
                        Welcome back,
                    </p>
                    <p className="self-center whitespace-nowrap text-lg font-bold text-gray-50 dark:text-white">
                        {loggedUser?.fullName ? loggedUser.fullName : loggedUser?.username}
                    </p>
                </div>
